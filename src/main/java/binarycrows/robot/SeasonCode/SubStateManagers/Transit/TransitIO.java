...
public interface TransitIO {
    ...
    public class TransitOutputs {
        public double leftLatitudinalMotorRequestedVoltage = 0;
        ...
        public double rightLatitudinalMotorRequestedVoltage = 0;
        ...
        public double longitudinalMotorRequestedVoltage = 0;
        ...
        public double inAndUpMotorRequestedVoltage = 0;
