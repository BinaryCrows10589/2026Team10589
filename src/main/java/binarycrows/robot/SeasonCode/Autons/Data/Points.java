...
public class Points {
    ...
    public static final CMAutonPoint CenterFuelQuadrant_OwnAllianceHumanPlayer = new CMAutonPoint(7.775+0, 8.069- (4.580+1), 0, 0, 0, 0);
    public static final CMAutonPoint crossOverPointHumanPlayer = new CMAutonPoint(5.714+0.25, 8.069- (6.455-.6));
    ...
    public static final CMAutonPoint CenterFuelQuadrant_OwnAllianceHumanPlayer_Second = new CMAutonPoint(7.775-0.1, 8.069- 4.580, 0, 0, 0, 0);
    ...
    public static final CMAutonPoint crossOverPoint = new CMAutonPoint(5.714+0.25, 6.455-.6);
    ...
    public static final CMAutonPoint PEnd_OwnAllianceDepot = new CMAutonPoint(7.280-5, 5.825, 0, 0, 0, 0);
